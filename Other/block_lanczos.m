function f = block_lanczos(Afun, B, func, iter)
% This code is a slightly modified version of the block Lanczos method from
% https://github.com/RaphaelArkadyMeyerNYU/HutchPlusPlus.
...
%
	...
	for i = 1:iter-1
		...
		K(:,:,i+2) = Afun(K(:,:,i+1)) - bsxfun(@times,K(:,:,i),beta(i+1,:));
